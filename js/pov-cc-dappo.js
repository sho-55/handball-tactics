...
export function ccDappoPov(source,mirror,E){
  ...
  if(!mirror){
    ...
    const cc={...chain([s[0],s[1],last]),mainline:true,from:1.9,playFrom:1.9,label:'①RWへCC → 左のLBがロング',text:'アウトを強く狙ってRWへCC。右サイドへ移り、逆側の縦の2対2を見届ける。'};
