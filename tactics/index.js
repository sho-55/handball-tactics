...
window.TACTIC_LIST = [
  { id: "05", file: "05-yugo.js", title: "ユーゴ（5番）", summary: "3枚目を引き付けて、回り込んだLBとPVで縦の2対2、対角のRBで広い1対1", pov: ["RB"],
    povCards: [
  ...
  { id: "06", file: "06-side-yugo.js", title: "サイドユーゴ（6番）", summary: "片側にDFを寄せて、反対側で広い3対2を作る", pov: ["RB"],
    povCards: [
