  ...
  steps: [
    // ---------------------------------------------------------------- (1)
    {
      ...
      actions: [
        ...
        { t: 0.1, dur: 1.5, type: "move", who: "PV", to: [[10.0, 7.7], [6.6, 7.7], [6.6, 6.2]] },
        { t: 0.6, dur: 1.4, type: "move", who: "LW", to: [[0.9, 5.2], [2.4, 7.6]] },
        { t: 0.9, dur: 0.9, type: "move", who: "LB", to: [[3.4, 5.6]] },
        { t: 1.2, dur: 0.6, type: "move", who: "L2", to: [[4.5, 5.8]] },
        { t: 2.0, dur: 0.4, type: "pass", from: "LB", to: "LW", hand: "左" },
        { t: 2.3, dur: 0.8, type: "move", who: "LB", to: [[1.4, 3.0]] },
      ],
      branches: [
        { group: "LBの選択肢", label: "②PVへパス", from: 1.9, text: "左2枚目がLBに出てきて左2-3のPVが空いたら、PVへパス。",
          actions: [{ t: 0, dur: 0.6, type: "move", who: "L2", to: [[4.7, 4.4], [3.4, 4.4]] }, { t: 0.7, dur: 0.5, type: "pass", from: "LB", to: "PV", kind: "bounce" }, { t: 1.3, dur: 0.6, type: "shoot", who: "PV" }] },
        { group: "LBの選択肢", label: "③1-2カットイン", from: 1.9, text: "左1枚目と左2枚目の間が空いていれば、そのままカットインしてシュート。",
          actions: [{ t: 0.0, dur: 0.8, type: "move", who: "LB", to: [[3.7, 4.25]] }, { t: 0.8, dur: 0.6, type: "shoot", who: "LB" }] },
    ...
    // ---------------------------------------------------------------- (2)
    {
      ...
      notes: ["RBは右で2対2の準備。"],
      actions: [
        { t: 0.0, dur: 0.5, type: "move", who: "CB", to: [[7.4, 10.2]] },
        { t: 0.3, dur: 0.6, type: "pass", from: "LW", to: "CB" },
        { t: 0.9, dur: 2.2, type: "zone", rect: [4.8, 4.6, 4.8, 6.2], label: "縦の2対2" },
        { t: 1.0, dur: 1.8, type: "move", who: "LW", to: [[8.0, 8.8], [12.1, 8.0], [13.4, 6.6]] },
        { t: 2.2, dur: 0.6, type: "move", who: "CB", to: [[7.2, 9.0]] },
        { t: 1.2, dur: 0.8, type: "move", who: "RB", to: [[14.6, 8.8]] },
        { t: 1.4, dur: 0.6, type: "move", who: "L3", to: [[7.9, 7.6]] },
      ],
      branches: [
        ...
        { group: "CBの選択肢", label: "②左3枚目を引き出してRBへ → PVは右3枚目裏へ", from: 1.0,
          ...
          actions: [
            { t: 0.0, dur: 0.6, type: "move", who: "CB", to: [[7.6, 9.2]] },
            { t: 0.2, dur: 0.7, type: "move", who: "L3", to: [[7.9, 7.8], [6.5, 7.5]] },
            { t: 0.9, dur: 0.8, type: "pass", from: "CB", to: "RB" },
            { t: 1.0, dur: 1.2, type: "move", who: "PV", to: [[10.6, 6.2]] },
            { t: 1.0, dur: 0.7, type: "move", who: "R3", to: [[12.0, 7.7]] },
            { t: 2.3, dur: 0.6, type: "pass", from: "RB", to: "PV", kind: "bounce" },
            { t: 3.0, dur: 0.6, type: "shoot", who: "PV" },
          ] },
        { group: "CBの選択肢", label: "③左1-2割（PVはアウトブロックに切替）", from: 1.0,
          text: "PVが左2枚目にかぶられたら、PVは左2枚目のアウトブロックに切り替え。CBは左1枚目と左2枚目の間を割ってシュート。",
          actions: [
            { t: 0.0, dur: 1.8, type: "move", who: "LW", to: [[8.0, 8.8], [12.1, 8.0], [13.4, 6.6]] },
            { t: 0.0, dur: 0.6, type: "move", who: "L2", to: [[5.4, 6.4]] },
            { t: 1.8, dur: 0.9, type: "block", who: "PV", to: [[6.6, 7.7], [4.2, 7.7], [4.2, 6.4]] },
            { t: 2.8, dur: 1.0, type: "move", who: "CB", to: [[3.0, 8.0], [3.0, 5.0]] },
            { t: 3.8, dur: 0.6, type: "shoot", who: "CB" },
          ] },
      ],
    },
    // ---------------------------------------------------------------- (3)
    {
      ...
      actions: [
        ...
        { t: 1.6, dur: 0.6, type: "move", who: "L3", to: [[7.9, 6.3]] },
      ],
      branches: [
        ...
        { group: "RBの選択肢", label: "②右3枚目つり出しLWバウンド", from: 0.9,
          ...
          actions: [
            ...
            { t: 0.9, dur: 0.5, type: "pass", from: "RB", to: "LW", kind: "bounce" },
        ...
        { group: "RBの選択肢", label: "③PVパス（左3枚目いない）", from: 0.9, text: "左3枚目がPVについて来ていなければ、3-3のPVへポストパス。",
          actions: [{ t: 0, dur: 0.7, type: "move", who: "PV", to: [[9.6, 6.4]] }, { t: 0.8, dur: 0.6, type: "pass", from: "RB", to: "PV", kind: "bounce" }, { t: 1.5, dur: 0.6, type: "shoot", who: "PV" }] },
        { group: "RBの選択肢", label: "④CBに逆展開（左3枚目がPVにかぶった）", from: 0.9,
          text: "左3枚目がPVにかぶってポストパスが出せない時は、CBへ逆展開。(4)へ。",
          actions: [
            { t: 0.0, dur: 0.6, type: "move", who: "L3", to: [[9.0, 7.7]] },
            { t: 0.6, dur: 0.9, type: "pass", from: "RB", to: "CB" },
            { t: 0, dur: 0.7, type: "move", who: "PV", to: [[9.6, 6.4]] },
            { t: 1.5, dur: 0.8, type: "move", who: "PV", to: [[6.6, 6.2]] },
            { t: 1.6, dur: 0.9, type: "move", who: "CB", to: [[3.0, 8.0], [3.0, 5.6]] },
    ...
    // ---------------------------------------------------------------- (4)
    {
      ...
      actions: [
        ...
        { t: 0, dur: 0.4, type: "move", who: "L3", to: [[7.9, 7.7]] },
      ...
      branches: [
        ...
        { group: "CBの選択肢", label: "②アウト引っ張りPVパス", from: 1.8,
          ...
          actions: [
            ...
            { t: 0.2, dur: 0.7, type: "move", who: "L2", to: [[3.4, 5.4]] },
        ...
        { group: "CBの選択肢", label: "③左1枚目寄せてLBシュート", from: 1.8,
          ...
          actions: [
            ...
            { t: 0.9, dur: 0.5, type: "pass", from: "CB", to: "LB", kind: "bounce" },
