...
window.TACTICS["05"] = {
  ...
  steps: [
    // ---------------------------------------------------------------- (1)
    {
      ...
      pov: { RB: { cues: [
        { t: 0.0, face: "CB", look: "CB", say: "CBが前を狙う。逆パスが来るので手を上げて構える", est: true },
        { t: 0.9 },
        { t: 1.7, look: "LB", say: "LBがCBの後ろを回り込んでくるコースを見て、次のパスの準備", est: true },
      ] } },
    ...
    // ---------------------------------------------------------------- (2)
    {
      ...
      pov: { RB: { cues: [
        ...
        { t: 0.9, face: "R3", look: "R3", say: "すぐワイドに開いて1対1の準備。右3枚目が出るかを見る", est: true },
      ] } },
    ...
    // ---------------------------------------------------------------- (3)
    {
      ...
      pov: { RB: { cues: [
        { t: 0.0, look: "R3", say: "右3枚目がLBに釣れて出た → 自分にパスが来る" },
        { t: 0.3, face: ["R2", "R1"], look: "R3", say: "右3枚目がLBに釣れて出た → 自分にパスが来る" },
        { t: 0.7, face: ["R2", "R1"], look: ["R2", "R1"], say: "キャッチ前に右2枚目・右1枚目の位置を見ておく", est: true, stop: true },
        { t: 0.8 },
        { t: 1.7, say: "ワイドで広い1対1" },
      ] } },
