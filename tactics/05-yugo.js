  ...
  steps: [
    ...
    // ---------------------------------------------------------------- (2)
    {
      ...
      pov: { RB: { cues: [
        ...
        { t: 0.9, face: [12.5, 4.5], look: "R3", say: "すぐワイドに開いて1対1の準備。体はゴールに向けたまま、右3枚目が出るかを見る", est: true },
      ] } },
    ...
    // ---------------------------------------------------------------- (3)
    {
      ...
      pov: { RB: { cues: [
        ...
        { t: 0.7, face: [12.5, 4.5], look: ["R2", "R1"], say: "DFを見ながらボールをもらう。右2枚目・右1枚目の位置を確認", est: true, stop: true },
        { t: 1.7, say: "ワイドで広い1対1" },
      ] } },
