...
window.TACTICS["07"] = {
  ...
  steps: [
    ...
    // ---------------------------------------------------------------- (3)
    {
      title: "RBが左前へ走り、後ろを回るLBへパス。追う左2をブロック",
      text: "RBは左前へ走り込み、RBの後ろを回り込むLBへ交差しながらパス。RBは左2枚目がLBを追って通る進路で先に足を止め、インブロック。RWは少し遅れて右2枚目に立つだけのインブロック。LBは中へ切り込みながらロングの助走。（動きはユーザー確認済み。座標・速度・間合いは図からの推定で指導者確認）",
      notes: [
        "RBは左2枚目にインブロック。",
      ...
      actions: [
        { t: 0.9, dur: 0.5, type: "pass", from: "RB", to: "LB" },
        { t: 0.0, dur: 1.6, type: "block", who: "RB", to: [[7.2, 8.0]] },
        { t: 0.35, dur: 1.05, type: "move", who: "L2", to: [[5.7, 7.2]] },
        { t: 1.4, dur: 0.75, type: "move", who: "L2", to: [[6.35, 7.7]] },
        { t: 1.0, dur: 0.9, type: "block", who: "RW", to: [[14.0, 6.8]] },
        { t: 0.0, dur: 2.4, type: "move", who: "LB", to: [[6.6, 9.6], [8.4, 9.4]] },
      ],
    },
    // ---------------------------------------------------------------- (4)
    {
      ...
      actions: [
        { t: 0.0, dur: 0.1, type: "block", who: "RB", to: [[7.2, 8.0]] },
      ...
      branches: [
        ...
        { group: "3枚目が出てきた時", label: "空いたポストに落とす（RB）", from: 0.0,
          text: "左3枚目が出て、インブロックしているRBの前が空いたらRBへ。RBは体を内側に向けて受ける。（推定：追従した左2とパスコースが重ならない受け位置は指導者確認）",
          actions: [
            { t: 0.0, dur: 0.1, type: "block", who: "RW", to: [[14.0, 6.8]] },
            { t: 0.0, dur: 0.7, type: "move", who: "L3", to: [[8.95, 8.0]] },
            { t: 0.6, dur: 0.6, type: "move", who: "RB", to: [[6.9, 6.4]] },
